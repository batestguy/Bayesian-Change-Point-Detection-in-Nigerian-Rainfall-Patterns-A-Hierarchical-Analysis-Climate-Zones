#!/usr/bin/env -S colab run --gpu T4 --timeout 3600
"""
Self-contained MCMC script for Google Colab.
Installs deps, embeds CSV data, runs all models, saves output.
"""
import subprocess, sys, os, time

# ── Install dependencies ────────────────────────────────────────────────
print("Installing PyMC and dependencies...")
t0 = time.time()
subprocess.check_call([
    sys.executable, "-m", "pip", "install", "-q",
    "pytensor>=2.15", "pymc==5.8.0", "arviz==0.16.1",
    "pandas", "numpy",
])
